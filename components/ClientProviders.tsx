        ...
        <header className="bg-white dark:bg-gray-950 shadow sticky top-0 z-20">
          <nav className="max-w-5xl mx-auto flex items-center justify-between px-4 py-3">
            ...
            <div className="flex gap-2 sm:gap-4 items-center">
              ...
              <a href="/" className="px-3 py-1 rounded text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition">Панель загрузки</a>
              <ThemeToggle />
            </div>
          </nav>
        </header>
