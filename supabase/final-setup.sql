...
-- Сначала создаём таблицу sources
...
-- Вставка тестовых источников данных
...
-- Теперь создаём таблицу documents
...
DROP POLICY IF EXISTS "Allow public read access" ON public.sources;
